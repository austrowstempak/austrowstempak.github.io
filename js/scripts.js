$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b03348aaff7c510376ef411ff29c4f35'
            && MD5($('#invite_code').val()) !== '2ac7f43695eb0479d5846bb38eec59cc') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbyqDup4hioVpqwkneK5u1Dlj_a8msTHQfvUlQEPKK8r48gWtfHaHKAM4MOreh2WYfH-Cw/exec', data)
                .done(function (data) {
                    console.log(data);
...
function initBBSRMap() {
    var la_fiesta = {lat: 41.481680738554815, lng: -81.33395751249527};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
